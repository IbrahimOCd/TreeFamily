...
?>
			...
			<div id="HiddenPopup" style="display:none;">
				<ul>
					...
					<li><?php echo $this->Html->link(__('Add Mother or Father'), ['action'=>'add', 'parent', '__n__'], ['class'=>'toggle']); ?></li>
					<li><?php echo $this->Html->link(__('Add Partner'), ['action'=>'add', 'spouse', '__n__'], ['class'=>'toggle']); ?></li>
					<li><?php echo $this->Html->link(__('Add Sibling'), ['action'=>'add', 'sibling', '__n__'], ['class'=>'toggle']); ?></li>
					<li><?php echo $this->Html->link(__('Add Child'), ['action'=>'add', 'child', '__n__'], ['class'=>'toggle']); ?></li>
				</ul>
			</div>
